...
urlpatterns = [
    ...
    path('delete_article_post/<int:post_id>/', views.delete_article_post, name="delete_article_post"),
    path('edit_article_post/<int:post_id>', views.edit_article_post, name="edit_article_post"),
]
