...
def checkout(request):
    ...
    if request.method == 'POST':
            ...
            for item_id, item_data in bag.items():
                try:
                    ...
                    messages.error(request, (
                        "Sorry, Mate! One of the products in your bag has been lost in the ether."
        ...
        bag = request.session.get('bag', {})
        if not bag:
            messages.error(request, "All empty, Mate.")
...
def checkout_confirmation(request, order_number):
    ...
    messages.success(request, f'Order has been completed! \
